...
#Install iksemel
cd /usr/src
wget https://github.com/timothytylee/iksemel-1.4/archive/refs/tags/v1.4.2.tar.gz
...
wget -O jansson.tar.gz https://github.com/akheron/jansson/archive/refs/tags/v2.7.tar.gz
wget https://github.com/pjsip/pjproject/archive/refs/tags/2.5.5.tar.gz
...
rm -f dahdi-linux-complete-2.10.0+2.10.0.tar.gz
